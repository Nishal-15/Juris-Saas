...
export default function ChatWindow() {
  ...
  const send = async (text) => {
    ...
    const updated = [...messages, { role: "user", text: userText }, { role: "ai", isThinking: true }];
    ...
    <div style={{ display: 'flex', height: '100%', width: '100%', overflow: 'hidden' }}>
      ...
      <div className="chat-wrap" style={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column' }}>
                 ...
                 <div className={`bubble ${m.role}`}>
                   {m.isThinking ? (
                     <div className="thinking-container">
                        <svg className="thinking-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg>
        ...
        <div className="chat-input-area">
          ...
          <p className="chat-input-hint"><strong>Disclaimer:</strong> JurisBot AI is a legal assistant, not a human lawyer. It does not provide formal legal counsel. Always verify critical information.</p>
        </div>
