...
export default function PwaInstallPill() {
  ...
  return (
    <>
      ...
      <button onClick={handleClick} className="pwa-floating-pill" title="Install JurisBot Lawyer App">
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", borderBottom: "1px solid rgba(255,255,255,0.1)", paddingBottom: "12px" }}>
              <h3 style={{ margin: 0, color: "#c9a84c", fontSize: "1.25rem", fontFamily: "'Playfair Display', serif", fontWeight: 700 }}>📲 Install Lawyer PWA</h3>
            ...
            <p style={{ fontSize: "0.95rem", lineHeight: 1.5, color: "#ccc", marginBottom: "18px" }}>
              Install JurisBot Lawyer Dashboard directly to your mobile home screen or tablet for fast, offline practice management:
            </p>
